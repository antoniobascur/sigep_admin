...
export default {
    ...
    computed: {
        ficha() {
            return this.$store.state.dsFichaSeguimiento;
        },
        dsData: {
            get() {
                return this.$store.state.dsFichaSeguimiento.data;
            },
            set(val) {
                this.$store.state.dsFichaSeguimiento.data = val;
            },
        },
