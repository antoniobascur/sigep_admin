<template>
    <div>
        ...
        >
            ...
            <kendo-grid-column field="FECHA" title="<b>FECHA</b>"></kendo-grid-column>
            <kendo-grid-column field="EVALUACION_PROFESOR_COLABORADR" title="<b>EVALUACION_PROFESOR_COLABORADR</b>"></kendo-grid-column>
            <kendo-grid-column field="EVALUACION_CENTRO_PRACTICA" title="<b>EVALUACION_CENTRO_PRACTICA</b>"></kendo-grid-column>
            <kendo-grid-column field="OBSERVACION" title="<b>OBSERVACION</b>"></kendo-grid-column>
...
export default {
    ...
    computed: {
        ficha() {
            return this.$store.state.dsFichaEvaluacion;
        },
        dsData: {
            get() {
                return this.$store.state.dsFichaEvaluacion.data;
            },
            set(val) {
                this.$store.state.dsFichaEvaluacion.data = val;
            },
        },
