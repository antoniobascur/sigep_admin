<template>
    <div>
        ...
        >
            ...
            <kendo-grid-column field="PROPOSITO" title="<b>PROPOSITO</b>"></kendo-grid-column>
            <kendo-grid-column field="NRO_VISITA" title="<b>NRO_VISITA</b>"></kendo-grid-column>
...
export default {
    ...
    computed: {
        ficha() {
            return this.$store.state.dsFichaVisita;
        },
        dsData: {
            get() {
                return this.$store.state.dsFichaVisita.data;
            },
            set(val) {
                this.$store.state.dsFichaVisita.data = val;
            },
        },
