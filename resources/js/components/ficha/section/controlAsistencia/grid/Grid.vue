<template>
    <div>
        ...
        >
            ...
            <kendo-grid-column field="HORA_LLEGADA" title="<b>HORA_LLEGADA</b>"></kendo-grid-column>
            <kendo-grid-column field="HORA_SALIDA" title="<b>HORA_SALIDA</b>"></kendo-grid-column>
...
export default {
    ...
    computed: {
        ficha() {
            return this.$store.state.dsControlAsistencia;
        },
        dsData: {
            get() {
                return this.$store.state.dsControlAsistencia.data;
            },
            set(val) {
                this.$store.state.dsControlAsistencia.data = val;
            },
        },
