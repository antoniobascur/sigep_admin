<template>
    <div>
        ...
        >
            ...
            <kendo-grid-column field="TIPO_SOLICITUD" title="<b>TIPO SOLICITUD</b>"></kendo-grid-column>
...
export default {
    ...
    computed: {
        dsTipoSolicitud() {
            return this.$store.state.dsTipoSolicitud;
        },
        dsData: {
            get() {
                return this.$store.state.dsTipoSolicitud.data;
            },
            set(val) {
                this.$store.state.dsTipoSolicitud.data = val;
            },
        },
            ...
            axios
                ...
                .then((response) => {
                    ...
                    if (response.data.data.length > 0) {
                        this.$store.state.dsTipoSolicitud.data = response.data.data;
                    }
                })
     ...
     /*      data = data.obj;
        ...
        eventHub.$on("onDeleteToGridElementTipoSolicitud", (data) => {
         ...
         var items = this.$store.state.dsTipoSolicitud.data;
            ...
            this.$store.state.dsTipoSolicitud.data = items;
            this.getData();
        });
    },
    beforeDestroy() {
