...
class TipoSolicitudController extends Controller
{
    ...
    public function save(Request $request){
        try {
            $validator = Validator::make($request->all(), RulesValidation::ValidateTipoSolicitud());
            if ($validator->fails()) {
            ...
            $dev = new TipoSolicitud($tipo_solicitud, $descripcion);
    ...
    public function get($idTipoSolicitud){
    try {


        $result = TipoSolicitud::get($idTipoSolicitud);
...
public function delete($idTipoSolicitud){
        try {


            $idResp = TipoSolicitud::delete($idTipoSolicitud);
